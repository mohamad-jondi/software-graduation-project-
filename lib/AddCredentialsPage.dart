...
class _AddCredentialsPageState extends State<AddCredentialsPage> {
  ...
  void _submitCredentials() async {
    for (int i = 0; i < _numCredentials; i++) {
      ...
      if (image == null) throw Exception("7ot sora ya ayre");

      var imagesAsBytes = await image.readAsBytes();
      var encodedImageBase64 = base64Encode(imagesAsBytes);

      Provider.of<AppProvider>(context, listen: false)
          .uploadDoctorCrediential(credentialText, encodedImageBase64);
