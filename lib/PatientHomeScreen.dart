...
import 'package:flutter_app/widgets/DoctorWidget.dart';
            ...
            children: [
              ...
              if (provider.searchText.isEmpty) ...[
                ...
                Wrap(
                  ...
                  children: [
                    _buildCategoryItem(
                        context, Icons.local_hospital, 'General'),
                    _buildCategoryItem(
                        context, Icons.pregnant_woman, 'Lungs Specialist'),
                    _buildCategoryItem(
                        context, Icons.medical_services, 'Dentist'),
                    _buildCategoryItem(
                        context, Icons.psychology, 'Psychiatrist'),
          ...
          child: Column(
            ...
            children: [
              CircleAvatar(
                ...
                backgroundColor: provider.selectedCategory == label
                    ? Color(0xFF199A8E)
                    : Colors.grey[200],
                child: Icon(icon,
                    size: 40,
                    color: provider.selectedCategory == label
                        ? Colors.grey[200]
                        : Color(0xFF199A8E)), // Increase icon size
              ),
              SizedBox(height: 5),
              Text(label,
