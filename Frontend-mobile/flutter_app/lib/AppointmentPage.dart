              ...
              child: ListView(
                children: [
                  ...
                  _buildDescriptionSection(
                    context,
                    description:
                        'I am experiencing intermittent abdominal pain localized in the lower right quadrant. The pain has been persistent for the past 24 hours and has gradually intensified. The patient describes the pain as sharp and stabbing, occasionally radiating towards the back. There is no relief from the pain with over-the-counter analgesics.',
                  ),
                  SizedBox(height: 16),
                  _buildSection(
                    context,
